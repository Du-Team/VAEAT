...
class Options:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--lstm_h_dim', type=int, default=80, help='size of lstm hidden unit')
        self.parser.add_argument('--nz', type=int, default=40, help='size of the latent z vector')
        self.parser.add_argument('--device', type=str, default='gpu', help='Device: gpu | cpu')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0. use -1 for CPU')
        self.parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')
        self.parser.add_argument('--model', type=str, default='VAEATModel', help='detection model')
